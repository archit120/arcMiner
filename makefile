all:
	...
	g++ -o arcMinerd AppLog.o arcMiner.o Helpers.o NetworkHelpers.o ScryptCPUMiner.o StratumHelpers.o StratumNetwork.o StratumProtocol.o ThreadLock.o scrypt-linux.o arcMiner/Assembly/scrypt-x64.S arcMiner/Assembly/sha2-x64.S sha2-linux.o -lpthread
