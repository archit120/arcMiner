...
static __inline void sha256d_preextend(uint32_t *W)
{
...
static __inline void sha256d_prehash(uint32_t *S, const uint32_t *W)
{
	uint32_t t0, t1;
	RNDr(S, W, 0);
	RNDr(S, W, 1);
...
static __inline void sha256d_ms(uint32_t *hash, uint32_t *W,
	const uint32_t *midstate, const uint32_t *prehash)
{
	uint32_t S[64];
	uint32_t t0, t1;
...
/*static __inline int scanhash_sha256d_4way(int thr_id, uint32_t *pdata,
	const uint32_t *ptarget, uint32_t max_nonce, unsigned long *hashes_done)
{
	__declspec(align(128))		uint32_t data[4 * 64];
	__declspec(align(32))		uint32_t hash[4 * 8];
	__declspec(align(32))		uint32_t midstate[4 * 8];
	__declspec(align(32))		uint32_t prehash[4 * 8];
...
/*static __inline int scanhash_sha256d_8way(int thr_id, uint32_t *pdata,
	const uint32_t *ptarget, uint32_t max_nonce, unsigned long *hashes_done)
{
